...
set -ex && sudo apt-get install --yes --no-install-recommends --allow-unauthenticated openjdk-$JAVA_VERSION-jdk-headless
...
set -ex && sudo apt-get install --yes --no-install-recommends --allow-unauthenticated build-essential -yq python3-pip
